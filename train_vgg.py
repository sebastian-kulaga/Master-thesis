...
from pyimagesearch.VGG19 import VGG19
...
ap.add_argument("-p", "--plot", type=str, default="plotvgg_lre4e250.png",
...
model = VGG19.build(width=120, height=90, depth=3, classes=5)
print(model.summary())
